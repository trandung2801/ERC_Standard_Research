...
interface ERC721 /* is ERC165 */ {
    ...
    //returns the number of NFTs of an user
    ...
    function _checkOnERC721Received() private pure return(bool) {
        return true;
    }
    ...
    function transferFrom(address from, address to, uint256 tokenId) public payable {
        ...
        require(
            ...
            "msg.sender is not the owner or approved for tranfer"
        );
        require(owner == from, "from address is not the owner");
        require(to != address(0), "Address is the zero address");


        approve(address(0), tokenId); // reset owner of tokenId
        _balances[from] -= 1;
        _balances[to] += 1;
        _owners[tokenId] = to;
    ...
    /// @param _approved The new approved NFT controller (to)
